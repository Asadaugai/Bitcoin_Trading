#Extract the tweets and single person and perform centiment analysis
...
def main():
    driver = init_driver()
    users =['realDonaldTrump','jpmorgan','@__SayI0r']
    username = '__SayI0r'
    try:
        tweets = get_elon_musk_tweets(username, driver, count=5)
       
        sentiments = analyze_sentiment(tweets)
        print("\nLatest Tweets with Sentiment:")
