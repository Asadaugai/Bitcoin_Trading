...
2. Use market data to contextualize sentiment. Analyze both 1-hour and 4-hour data, using:
   - Current Price: Current Bitcoin price
   - Volume: Average trading volume (high volume strengthens sentiment)
   - Volatility: Standard deviation of returns (high volatility may signal uncertainty)
   - Price Change: Price change % (positive/negative trends influence sentiment)
   ...
   - Give more weight to 4-hour data but use 1-hour metrics to detect short-term momentum shifts.
